...
<html lang="en">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154619907-5"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-154619907-5');
    </script>

    <title>WGLabz-IoT, Blogging and More</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="p:domain_verify" content="404c7a69c1b06e3feec4a4164fdc8abf"/>
    ...
    <div class="site-navbar-wrap" >
      <div class="site-navbar-top">
        <div class="container py-3">
          <div class="row align-items-center">
            <div class="col-6">
              <a href="https://twitter.com/wglabz" class="p-2 pl-0"><span class="icon-twitter"></span></a>
              <a href="https://www.facebook.com/wglabz" class="p-2 pl-0"><span class="icon-facebook"></span></a>
              <a href="https://www.linkedin.com/company/wglabz" class="p-2 pl-0"><span class="icon-linkedin"></span></a>
              <a href="https://instagram.com/wglabz" class="p-2 pl-0"><span class="icon-instagram"></span></a>
              <a href="https://www.youtube.com/channel/UCo3jik11kHu65uQBGueaw4g" class="p-2 pl-0"><span class="icon-youtube"></span></a>
              <a href="https://github.com/oksbwn" class="p-2 pl-0"><span class="icon-github"></span></a>
            ...
            <div class="col-6">
              <div class="d-flex ml-auto">
                <a href="#" class="d-flex align-items-center ml-auto mr-4">
                  ...
                  <span class="d-none d-md-inline-block">weargeniuslabs@gmail.com</span>
                </a>
                <a href="#" class="d-flex align-items-center">
                  <span class="icon-phone mr-2"></span>
                  <span class="d-none d-md-inline-block">9439 *** ***</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="site-navbar site-navbar-target js-sticky-header" style="background:#4285f4 !important;">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-2">
              <h1 class="my-0 site-logo"><a href="index.html">WGLabz</a></h1>
            </div>
            <div class="col-10">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/hero_bg_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5"id="home-section">
      <div class="container">
        <div class="row align-items-center text-center justify-content-center">
          <div class="col-md-8">
            <a data-fancybox data-ratio="2" href="https://www.youtube.com/watch?v=ZGn6aez1iu8" class="play-button d-block">
              <span class="icon-play"></span>
            </a>
            <h1 class="text-uppercase">WeArGenius Labs</h1>
            <span class="sub-text mb-3 d-block"><em>Content and Projects around IoT, Embedded System, Smart Home and stuffs around it.</em></span>
          </div>
        </div>
      </div>
    </div>  
